...
def loginInSystem(requestInfo):
    permanentID = getpermanentID(rooturl=requestInfo.rooturl,headers=requestInfo.headers,loginurl=requestInfo.loginurl)
    ...
    response = requestNeedurl(needurl  = requestInfo.loginurl ,postData = postData,headers = requestInfo.headers,CookieOpener = requestInfo.CookieOpener)
    fullcookies = ''
    for item in requestInfo.cookie:
